...
def setup_colab():
    ...
    print("🚀 Installing libraries (Whisper, Gemini, etc.)...")
    packages = ["openai-whisper", "google-generativeai", "python-dotenv", "anthropic"]
...
"""
    ...
    # Using gemini-2.0-flash as a reliable high-speed model
